classdef temp < handle
    ...
    methods
        function obj = temp(Options)
            arguments
                Options padv.pipeline.GitLabOptions
                
            end
            obj.GithubOptions = Options;
            ...
            obj.permissions={obj.checksKeyword, obj.ContentsKeyword};
        ...
        function generatorResults = generatePipeline(obj, irPipeline)
            ...
            obj.generateKeywordHierarchy;
            githubPipeline = padv.pipeline.internal.github.IR2GithubPipelineConvertor.convert(irPipeline, "pipeline name");
